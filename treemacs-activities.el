...
;; URL: https://github.com/chuxubank/treemacs-activities
;; Package-Requires: ((emacs "29.1") (treemacs "0.0") (activities "0.7.2") (dash "2.11.0"))
...
(declare-function activities-tabs--tab "activities-tabs" (activity))
(declare-function activities-tabs--tab-parameter "activities-tabs" (parameter tab))
...
Only considers buffers that belong to a real project, such as a git
repository.  Plain directories are never returned.  Returns a list of
...
project roots.  If none are found, fall back to the current project
before copying the fallback workspace."
  (treemacs-block
...
(defun treemacs-activities--format-workspace-name (activity-name)
  "Return treemacs workspace name for ACTIVITY-NAME."
